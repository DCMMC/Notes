...
\node (S_0) at (18.556bp,12.0bp) [draw,ellipse] {$S_0$};
  ...
  \node (S_3) at (288.56bp,12.0bp) [draw,ellipse] {$S_3$};
  ...
  \draw [->] (S_2) ..controls (188.38bp,30.794bp) and (190.56bp,41.0bp)  .. (198.56bp,41.0bp) .. controls (203.55bp,41.0bp) and (206.28bp,37.013bp)  .. (S_2);
  \draw (198.56bp,50.0bp) node {$0.75$};
  \draw (186.0bp,27.505bp) node {$$};
  \draw (211.11bp,27.505bp) node {$$};
  \draw [->] (S_2) ..controls (224.9bp,12.0bp) and (248.41bp,12.0bp)  .. (S_3);
  \draw (243.56bp,21.0bp) node {$0.25$};
  \draw (217.06bp,6.0bp) node {$$};
  \draw (270.05bp,6.0bp) node {$$};
%
\end{tikzpicture}
